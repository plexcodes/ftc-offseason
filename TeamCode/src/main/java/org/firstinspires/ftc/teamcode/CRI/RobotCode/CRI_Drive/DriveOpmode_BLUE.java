...
import org.firstinspires.ftc.teamcode.CRI.Static.GamepadEx;
...
public class DriveOpmode_BLUE extends OpMode {
    ...
    public void loop() {
        ...
        drive.vectorMove(-gamepad1.left_stick_x, gamepad1.left_stick_y, gamepad1.left_trigger - gamepad1.right_trigger, 0.92);
