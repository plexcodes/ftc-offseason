...
import org.firstinspires.ftc.teamcode.Bobot.roadrunner.util.LoggingUtilOLD;
import org.firstinspires.ftc.teamcode.Bobot.roadrunner.util.RegressionUtilOLD;

import java.util.ArrayList;
import java.util.List;

import static org.firstinspires.ftc.teamcode.Bobot.roadrunner.drive.DriveConstantsOLD.MAX_RPM;
import static org.firstinspires.ftc.teamcode.Bobot.roadrunner.drive.DriveConstantsOLD.RUN_USING_ENCODER;
import static org.firstinspires.ftc.teamcode.Bobot.roadrunner.drive.DriveConstantsOLD.rpmToVelocity;
...
public class AutomaticFeedforwardTunerOLD extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RegressionUtilOLD.RampResult rampResult = RegressionUtilOLD.fitRampData(
                timeSamples, positionSamples, powerSamples, fitIntercept,
                LoggingUtilOLD.getLogFile(Misc.formatInvariant(
        ...
        if (fitAccelFF) {
            ...
            RegressionUtilOLD.AccelResult accelResult = RegressionUtilOLD.fitAccelData(
